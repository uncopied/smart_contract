...
../../../node/goal app create --creator BJLWZRWS7CYNNTBNYPGGHF7ZFJU2JOCFKXZSEUTVDC4INZEW63WZ2QLIHI --app-arg "int:200" --approval-prog ../contracts/Price.teal --global-byteslices 2 --global-ints 2 --local-byteslices 1 --local-ints 1 --clear-prog ../contracts/clearprice.teal --out=unsginedtransaction2.tx
